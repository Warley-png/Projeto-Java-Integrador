...
//A linha de código abaixo e para verificar de quando for excluir cliente , o mesmo tem empréstimo ativo
    ...
    public void editarLivro(String nomeliv, String autorliv, String assuntoliv, String editoraliv, long idliv) {
        EntityManager em = JPAUtil.getEntityManager();
        ...
        try {
            ...
            String sql = "UPDATE Livros l SET l.nomeliv = :nomeliv, l.autorliv = :autorliv, l.assuntoliv = :assuntoliv, l.editoraliv = :editoraliv WHERE l.idliv = :idliv";
            Query consulta = em.createQuery(sql);
