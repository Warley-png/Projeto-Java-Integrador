...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(466, 219));
    ...
    public void logar() {
        ...
        if (tipoUsuario != null) {
            ...
            JOptionPane.showMessageDialog(null, "Olá " + login + ", sua permissão é de " + tipoUsuario);
            dispose();
            ...
            if ("admin".equals(tipoUsuario)) {
                ...
                mensagem += "Você tem acesso total ao sistema.\n Seja bem-vindo!";
            ...
            JOptionPane.showMessageDialog(this, mensagem, "Permissões", JOptionPane.INFORMATION_MESSAGE);
